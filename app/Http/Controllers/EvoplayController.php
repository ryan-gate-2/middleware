...
class EvoplayController extends \App\Http\Controllers\Controller
{
     ...
     */
    public function createSlots($playerId, $game_id, $extra_id, $casino_id, $mode, $nativecurrency)
    {
     ...
     */
    public function createFreeSlots($playerId, $game_id, $casino_id, $spins, $spinsvalue, $nativecurrency)
    {
        $evoexplode = explode('-', $playerId);
        $operatorevo = $casino_id;
        $unique = uniqid();
    ...
    public function createSuperFreeSlots($playerId, $game_id, $casino_id, $spins, $spinsvalue, $nativecurrency)
    {
        $evoexplode = explode('-', $playerId);
        $operatorevo = $casino_id;
        $unique = uniqid();
